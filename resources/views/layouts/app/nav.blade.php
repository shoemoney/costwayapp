<nav class="bg-white shadow">
    ...
    <div class="flex justify-between h-16">
      <div class="flex">
        ...
        <div class="hidden md:ml-6 md:flex">
          ...
          <a href="#" class="inline-flex items-center px-1 pt-1 border-indigo-500 text-sm leading-5 text-gray-900 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out">
            Activity
          </a> 
        </div>
      </div>
  ...
  <div class="hidden md:hidden">
    <div class="pt-2 pb-3">
        ...
        <a href="#" class="block pl-3 pr-4 py-2 border-l-4 border-indigo-500 text-base font-medium text-indigo-700 bg-indigo-50 focus:outline-none focus:text-indigo-800 focus:bg-indigo-100 focus:border-indigo-700 transition duration-150 ease-in-out sm:pl-5 sm:pr-6">Product Activity</a>
    </div>
